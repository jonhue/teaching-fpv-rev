...
\begin{block}{\centering \code{data $type$ $a_1 \dots a_n$ = $constructor$ $a_1k \dots a_l$ | ...}}
\end{block}
...
\begin{itemize}
    ...
    \item unary constructors are also called \textcolor{blue}{constants}.\pause
...
\begin{itemize}
    ...
    \item \code{newtype} is used to create a custom constructor for a single type without adding any runtime overhead\pause
\end{itemize}
